...
export function LoginForm() {
  ...
  const returnTo = params.get("returnTo") || "/alenya/dashboard";
    ...
    <form
      ...
      onSubmit={(e) => {
        ...
        startTransition(async () => {
          const res = await fetch("/api/alenya/auth/login", {
            method: "POST",
          ...
          router.push(returnTo.startsWith("/") ? returnTo : "/alenya/dashboard");
          router.refresh();
        });
      }}
    >
      ...
      >
        {pending ? "Entrando…" : "Entrar al Command Center"}
      </button>
    </form>
  );
}
